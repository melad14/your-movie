 ...
 return<>
  ...
  <div className='row my-3'>
    ...
    <div className="col-md-4 d-flex align-items-center">
     ...
     {trendingMovie.slice(0,10).map((mov,index)=><MediaItem mov={mov} key={index} /> )}
    </div>
  ...
  <div className='row my-5'>
    ...
    <div className="col-md-4 d-flex align-items-center">
     ...
     {trendingTv.slice(0,10).map((mov,index)=><MediaItem mov={mov} key={index} /> )}
    </div>
  ...
  <div className='row my-5'>
    ...
    <div className="col-md-4 d-flex align-items-center">
      ...
      <h2 className='h4'>trending  <br /> actors <br /> to watch now</h2>
      <p className='text-muted py-3'>most watched actor by day</p>

      <div className="brdr mt-2 w-100"></div>
      </div>
    </div>
     {trendingPerson.slice(0,10).map((mov,index)=><MediaItem mov={mov} key={index} /> )}
    </div>
